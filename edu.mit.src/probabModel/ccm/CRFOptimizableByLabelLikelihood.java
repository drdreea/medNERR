...
import probabModel.ccm.CRF.Factors;
import probabModel.ccm.CRF.Factors.Incrementor;
import probabModel.ccm.CRF.Factors.WeightedIncrementor;
...
public class CRFOptimizableByLabelLikelihood implements Optimizable.ByGradientValue, Serializable
{
  ...
  // gsc: changing field access to make this class extensible
	public InstanceList trainingSet;

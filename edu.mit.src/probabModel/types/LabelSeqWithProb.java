...
public class LabelSeqWithProb implements Comparable
{
    ...
    // clone an instance.
    public LabelSeqWithProb(LabelSeqWithProb other)
    {
        labelSeq = new ArrayList();
	probSeq = new ArrayList();
	logprobSeq = new ArrayList();
    ...
    public int compareTo(Object o)
    {
        ...
        LabelSeqWithProb ols = (LabelSeqWithProb) o;

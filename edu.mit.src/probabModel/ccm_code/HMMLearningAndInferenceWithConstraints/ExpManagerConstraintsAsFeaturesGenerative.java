...
public class ExpManagerConstraintsAsFeaturesGenerative {
		...
		for(int i=0;i<trainSetSize.length;i++){
			for(int runId=0;runId<1;runId++){
				//for(Parameters.inferenceMethod=0;Parameters.inferenceMethod<3;Parameters.inferenceMethod++){
					String[] params={"data/citation_train."+trainSetSize[i]+"."+runId+".txt","data/citation_test.txt","data/citation_unlabeled.txt","0","0" ,"0.9"};

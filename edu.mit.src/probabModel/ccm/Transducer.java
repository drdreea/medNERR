...
public abstract class Transducer implements Serializable
{
  ...
  // "op" = "output position"
	...
	public SumLatticeFactory sumLatticeFactory;
	...
	public Transducer ()
	{
		...
		maxLatticeFactory = new AStarInference.Factory();
	}
	...
	public Instance transduce (Instance instance)
	{
		if (inputPipe != null)
			instance = inputPipe.instanceFrom(instance);
		// TODO Use MaxLatticeFactory instead of hardcoding 
		instance.setData(new AStarInference(this, (Sequence)instance.getData()).bestOutputSequence());
		if (outputPipe != null)
			instance = outputPipe.instanceFrom(instance);
		return instance;
	}

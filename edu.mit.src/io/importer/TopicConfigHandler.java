 ...
 *
 */
public class TopicConfigHandler extends ConfigHandler{
	public Properties configFile ;
	public String outputPathLab;
	public String outputPathMed;
	...
	static enum RequiredConfigs {   
		outputPathLab, outputPathMed, medsPath};
		static enum ConfigOptions { verbose };

		public TopicConfigHandler(String configFileName){
		...
		private void parseConfigFile(){
			...
			for (RequiredConfigs conf : RequiredConfigs.values()){
				...
				if (!new File(value).exists() ){
					if(conf != RequiredConfigs.outputPathMed){

 ...
 * 
 * Generated sentence boundaries serve as WINDOW for negation (suggested by
 * Wendy Chapman)
 * 
 * 
 * NOTES: If the negation scope exists in a sentence, it will print the negation
 * scope such as 1 - 1, 0 - 24. If the negation does not exist in a sentence, it
 * will print -1 If a pre-UMLS phrase is used as a post-UMLS phrase, for
 * example, pain and fever denied, it will print the negation scope of, in this
 * case, 0 - 2, for an option of yes or print -2 for an option of no
 * 
 ****************************************************************************************/
...
// post-negation phrases, and conjunction
...
// the database
    private void processPhrases(List<String> pseNegPhrases,
	    List<String> negPhrases, List<String> postNegPhrases,
...
// negPhrases.add("denying");
	...
	negPhrases.add("not need");
	negPhrases.add("not require");
...
// negPhrases.add("off"); // added by Bodnari a.
...
// postNegPhrases.add("stopped");
// postNegPhrases.add("discontinued");
// postNegPhrases.add("stop");
// postNegPhrases.add("hold");
// postNegPhrases.add("held");

...
public class MalletFeatValueSequence implements Sequence, Serializable
{
    Alphabet dictionary;
     ...
     */
    public MalletFeatValueSequence (Alphabet dict, int[] features,
			      double[] values)
    {
    ...
    public MalletFeatValueSequence (Alphabet dict, int capacity)
    {
	dictionary = dict;
    ...
    public MalletFeatValueSequence (Alphabet dict)
    {
	this (dict, 2);
    }

...
import probabModel.ccm_code.Experiments.HMMConstraintsMedicationSupervisedTeaching;
 ...
 *
 */
public class NERClassifierTeaching extends ClassifierBase{
	 ...
	 * @throws Exception 
	 */
	public NERClassifierTeaching(String config) throws Exception {
		super(config,false);
	 ...
	 */
	public void generateTrainTestFiles() throws SecurityException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException, InvocationTargetException{
		findPatternFrequency();
		findContextGS();
...
//		boolean trainTestProvided = true;
	...
	public static void main(String[] args) {
		...
		try{
			NERClassifierTeaching classifier = new NERClassifierTeaching(args[0]);
			...
			HMMConstraintsMedicationSupervisedTeaching hmmClassifier = new 
					HMMConstraintsMedicationSupervisedTeaching(classifier.attributeNames.size() + 2,
			...
			String[] classifierArguments = {classifier.configs.classifierOutputPath + "/" +
					...
					classifier.configs.classifierOutputPath + "/" +
							...
							classifier.configs.classifierOutputPath + "/" +
									...
									"/Users/ab/Documents/work2/MedicationExtraction/experiments/classifier/teaching_mallet.txt",
